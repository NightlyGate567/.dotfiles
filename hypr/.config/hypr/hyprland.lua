...
hl.monitor({ --> Configuration can differ
    output   = "eDP-1",
    mode     = "1920x1080@60",
    position = "0x0",
    scale    = "1.00",
...
hl.config({
    input = {
        kb_layout  = "de", --> Perhaps not your keyboard
        follow_mouse = 1,
        sensitivity = 0,
...
hl.bind(mainMod .. " + ESCAPE", hl.dsp.exec_cmd(exit))

hl.bind(mainMod .. " + W", hl.dsp.exec_cmd(terminal))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(fileManager))
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd(browser))
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd(eMail))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd(notes))
